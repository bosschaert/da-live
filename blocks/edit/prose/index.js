...
// DA
import { getSchema } from '@da-tools/da-parser';
...
export default function initProse({ editor, path }) {
  // loadScript('/deps/@da-tools/da-parser/lib/index.js')
  //   .then(() => {
  //     console.log('((( Loaded da-parser');
  //   })
  //   .catch((err) => {
  //     console.error('((( Error loading da-parser', err);
  //   });
